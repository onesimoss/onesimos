  ...
  return (
    <main 
      ...
      style={{ 
        ...
        // THIS IS THE KEY: Using CSS to load the raw image from the public folder
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-white font-medium mb-10 max-w-2xl drop-shadow-lg">
