...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-[rgba(63,6,194,0.74)] overflow-hidden flex flex-col items-center justify-center">
      ...
      {/* SOCIAL PROOF BADGES */}
      <div className="relative z-10 flex justify-center gap-6 text-white/80 text-sm font-semibold">
