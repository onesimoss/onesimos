      ...
      <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-sm">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-700 font-switzer">
          ...
          <section>
            ...
            <p>
              These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity (Parent, Guardian, or Educational Institution), and Example Mirror Ltd (operating as Onesimos). By accessing or using the platform, you confirm that you have read, understood, and agreed to be bound by all of these terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Onesimos is an interactive reading companion designed for children aged 3 to 9. The platform utilizes artificial intelligence, speech-to-text recognition, and synthesized audio to evaluate reading accuracy, track stumbling words, and generate personalized learning chapters.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-gray-600">
              ...
              <li>Free trial tiers grant 5 stories per month for 1 child profile.</li>
          ...
          <section>
            ...
            <p className="mt-2 font-bold text-amber-950">
              ...
              Company: Example Mirror Ltd, Lagos, Nigeria
            </p>
          </section>
        </div>
